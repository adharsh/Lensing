...
ScreenBuffer::ScreenBuffer(const std::string& vertex_shader_path, const std::string& fragment_shader_path, unsigned int width, unsigned int height, glm::vec4 clear_color, bool depth, bool stencil)
	: clear_color(clear_color)
{
	addVertexShader(vertex_shader_path.c_str());
	addFragmentShader(fragment_shader_path.c_str());
	compileShader();
